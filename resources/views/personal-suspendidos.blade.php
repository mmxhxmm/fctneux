        ...
        <div class="relative h-[450px] flex-grow-0 flex-shrink-0" style="background-image: url('../images/personalactivo.png'); background-size: cover; background-position: center;">
            ...
            <div class="absolute left-0 top-[6em] animate-left">
                ...
                <div class="absolute left-0 top-[10em] animate-left2">
                    <a href="personal-activo" class="hover:text-white hover:border-none rounded-tl-[0px] rounded-tr-[50px] px-4 rounded-br-[50px] rounded-bl-[0px] bg-blue w-[200px] h-[40px] opacity-90 text-[16px] text-white text-left font-roboto flex justify-start items-center"><<< Usuarios activos</a>
                 </div>
            </div>
                ...
                <div class="text-center justify-center mt-24 fade-in">
                    <p class="text-white text-three " style="text-shadow: 2px 4px 2px rgba(0,0,0,0.40)">
                        Personal <span class="text-three font-roboto_condensed_bold text-orange">Suspendidos</span>
                    </p>
                </div>
            </div>
        </div>
