        ...
        <div class="relative">
            <div class="bg-blue text-white text-center p-2 text-four">Datos de Tareas</div>
                <div class="p-8 flex justify-between items-start">
                    ...
                    <div class="w-[50%]">
                        <form method="POST" id="taskForm" action="{{ route('store-tareas') }}" class="w-full flex flex-col gap-y-3">
                            <div>
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" value="{{ old('descripcion', session('tarea')?->descripcion) }}" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"></textarea>
