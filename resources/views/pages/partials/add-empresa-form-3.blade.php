<section>
    ...
    <form method="POST" id="form" action="{{ route('store-empresa-3') }}" class="min-h-[30em] mt-6 space-y-6">
        ...
        <div id="practica" class="space-y-6" style="display:block">
            <!-- Nombre -->
            <!-- <div>
                <x-input-label for="nombre" :value="__('Título de la tarea')" />
            ...
            <div>
                <x-input-label for="cicloFormativo" :value="__('Ciclo/s Formativo/s')" />
            ...
            <!-- TODO: Multiple Selection -->
            <div>
                <x-input-label for="cursoAcademico" :value="__('Curso Academico')" />
            ...
            <!-- Periodo From -->
            <div>
                <x-input-label for="periodoFrom" :value="__('Periodo From')" />
            ...
            <!-- Periodo To -->
            <div>
                <x-input-label for="periodoTo" :value="__('Periodo To')" />
            ...
            <!-- Horario From -->
            <div>
                <x-input-label for="horarioFrom" :value="__('Horario From')" />
            ...
            <!-- Horario To -->
            <div>
                <x-input-label for="horarioTo" :value="__('Horario To')" />
            ...
            <!-- Convenio Marco -->
            <div>
                <x-input-label for="convenioMarco" :value="__('Convenio Marco')" />
            ...
            <!-- Uso Logos -->
            <div>
                <x-input-label for="usoLogos" :value="__('Uso Logos')" />
            ...
            <div>
                <x-input-label for="numPlazasAsignadas" :value="__('Número de Plazas Asignadas')" />
        ...
        <div id="tutor" class="space-y-6" style="display:block">
            <!-- DNI -->
            <div>
                <x-input-label for="tutor_dni" :value="__('DNI <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Nombre -->
            <div>
                <x-input-label for="tutor_nombre" :value="__('Nombre <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Apellido -->
            <div>
                <x-input-label for="tutor_apellido" :value="__('Apellido <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Telefono -->
            <div>
                <x-input-label for="tutor_telefono" :value="__('Teléfono')" />
            ...
            <!-- Email -->
            <div>
                <x-input-label for="tutor_email" :value="__('Email')" />
        ...
        <div id="tutorEmpresa" class="space-y-6" style="display:block">
            <!-- DNI -->
            <div>
                <x-input-label for="tutorEmpresa_dni" :value="__('DNI <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Nombre -->
            <div>
                <x-input-label for="tutorEmpresa_nombre" :value="__('Nombre <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Apellido -->
            <div>
                <x-input-label for="tutorEmpresa_apellido" :value="__('Apellido <span class=\'text-red-500\'>*</span>')" />
            ...
            <!-- Telefono -->
            <div>
                <x-input-label for="tutorEmpresa_telefono" :value="__('Teléfono')" />
            ...
            <!-- Email -->
            <div>
                <x-input-label for="tutorEmpresa_email" :value="__('Email')" />
