<section id="EditModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="w-full max-w-6xl bg-white rounded-xl shadow-2xl overflow-hidden border-t-4 border-blue">
        ...
        <div class="bg-blue px-6 py-4 flex justify-between items-center">
            ...
            <button id="closeEditModal" class="closeEditModal text-white text-xl hover:text-orange transition-all">✕</button>
        </div>
        ...
        <div class="p-8 flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2">
                <form method="POST" action="" id="tareaEditForm" autocomplete="off" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="md:col-span-3 flex justify-end gap-6 mt-4">
                        <button type="button" class="closeEditModal cancel-edit-btn">
                            Cancelar
                        </button>
