...
@if ($empresa->id == $id)
            ...
            <div class="w-full h-full flex flex-col  absolute px-4 ">
                ...
                <div class="text-center justify-center mt-20 fade-in">
                    <p class="text-white text-three " style="text-shadow: 2px 4px 2px rgba(0,0,0,0.40)">
                        Detalles de <span class="text-two font-roboto_condensed_bold text-orange">{{ $empresa->nombre }}</span>
                    </p>
                </div>
            </div>
        </div>
    <!-- <div class="py-6"> -->
        <div class=" mx-auto sm:px-6 lg:px-8 space-y-6 ">
            <!-- <div class="p-4 sm:p-8 border-blue border-2 shadow sm:rounded-lg"> -->
