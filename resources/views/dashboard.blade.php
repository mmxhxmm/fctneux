<x-app-layout>
    <div class="h-[80.55vh] w-full flex flex-col grid-rows-3 bg-white">
        <!-- Background Image Section -->
        <div class="relative h-[300px] flex-grow-0 flex-shrink-0" style="background-image: url('../images/fct-bg.png'); background-size: cover; background-position: center;">
            <!-- Opacity overlay -->
            ...
            <div class="w-full h-full flex flex-col items-center justify-center relative px-4 fade-in">
                <div class="text-center">
                    <p class="text-8xl font-hammersmith text-white" style="text-shadow: 2px 4px 2px rgba(0,0,0,0.40)">
        ...
        <!-- Buttons Section -->
        <div class="w-full relative my-14 sm:h-[100%] flex flex-col sm:flex-row items-start justify-center">
                ...
                <a href="{{ route('empresa-index') }}">
                    <button class="w-full h-full shadow-lg clip-diagonal hover:opacity-90 " style="background-image: url('../images/empresa-bg.png'); background-size: cover; background-position: center;">
                        <div class="text-white -mt-12 mr-6 text-bold h-[8em]">    
                            ...
                            <p class="mt-4 text-xl font-extrabold relative text-center">EMPRESAS</p>
                        </div>
                        <!-- Arrow cont -->
            ...
            <div class="relative w-full h-[15em] sm:h-full animate-right">
                <a href="{{ route('tareas-index') }}">
                    ...
                    <div class="text-white -mt-12 ml-6 text-bold h-[8em]">
                            ...
                            <p class="mt-4 text-xl font-extrabold relative text-center">TAREAS</p>
                    </div>
                    <!-- Arrow cont -->
                        <div class="absolute ml-3 top-[15.5em] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                            <div class="w-[4.3rem] h-[4.3rem] rounded-full bg-primary flex items-center justify-center">
