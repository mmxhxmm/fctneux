<x-app-layout>
    <div class="w-full flex flex-col grid-rows-3 bg-white h-[calc(100vh-50px)]">
        ...
        <div class="relative h-[250px] flex-grow-0 flex-shrink-0" style="background-image: url('../images/fct-bg.png'); background-size: cover; background-position: center;">
            ...
            <!-- Main Heading -->
            <div class="w-full h-[250px] flex flex-col items-center justify-center relative px-4 fade-in">
        ...
        <div class="w-full relative mt-12 mb-14 sm:h-[18em] flex flex-col sm:flex-row items-start justify-center">
            ...
            <div class="relative w-full h-[15em] sm:h-full animate-left">
                <a href="{{ route('empresa-index') }}">
                    <button class="w-full h-full shadow-lg clip-diagonal hover:opacity-90 " style="background-image: url('../images/empresa-bg.png'); background-size: cover; background-position: center;">
                        ...
                        <!-- Arrow cont -->
                        <div class="absolute pr-6 top-[13.5em] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div class="relative w-full h-[15em] sm:h-full animate-right">
                <a href="{{ route('tareas-index') }}">
                    ...
                    <!-- Arrow cont -->
                        <div class="absolute ml-3 top-[13.5em] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
