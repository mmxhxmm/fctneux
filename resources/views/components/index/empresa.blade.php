<div 
    ...
    data-aos-once="true"
    {{ $attributes->merge([
        'class' => 'user-card w-[380px] flex flex-col justify-between rounded-2xl p-6 border border-blue shadow-md hover:shadow-blue/30 transition-all duration-300',
        'tabindex' => 0
    ]) }}>
